...
.. raw:: html
   ...
   <div class="feature-grid">
     ...
     <div class="feature-card">
       ...
       <pre style="font-size:0.82em;margin:6px 0 4px 0;background:#f3f6fb;padding:8px 10px;border-radius:6px;line-height:1.6;">compute_integrity_score(log)  # tech<br>compute_aei(log)              # economics</pre>
